...
DriverControllerMaxon driverHipLeft(PIN_ENB_HIP_LEFT, PIN_DIR_HIP_LEFT, PIN_PWM_HIP_LEFT,
HIP_DRIVER_KP, HIP_DRIVER_KI, HIP_DRIVER_KD, PID_DRIVER_DT, encodHipLeftLink);
DriverControllerMaxon driverKneeLeft(PIN_ENB_KNEE_LEFT, PIN_DIR_KNEE_LEFT, PIN_PWM_KNEE_LEFT,
KNEE_DRIVER_KP, KNEE_DRIVER_KI, KNEE_DRIVER_KD, PID_DRIVER_DT, encodKneeLeftLink);
DriverControllerMaxon driverFootLeft(PIN_ENB_FOOT_LEFT, PIN_DIR_FOOT_LEFT, PIN_PWM_FOOT_LEFT,
FOOT_DRIVER_KP, FOOT_DRIVER_KI, FOOT_DRIVER_KD, PID_DRIVER_DT, encodFootLeftLink);
DriverControllerMaxon driverHipRight(PIN_ENB_HIP_RIGHT, PIN_DIR_HIP_RIGHT, PIN_PWM_HIP_RIGHT,
HIP_DRIVER_KP, HIP_DRIVER_KI, HIP_DRIVER_KD, PID_DRIVER_DT, encodHipRightLink);
DriverControllerMaxon driverKneeRight(PIN_ENB_KNEE_RIGHT, PIN_DIR_KNEE_RIGHT, PIN_PWM_KNEE_RIGHT,
KNEE_DRIVER_KP, KNEE_DRIVER_KI, KNEE_DRIVER_KD, PID_DRIVER_DT, encodKneeRightLink);
DriverControllerMaxon driverFootRight(PIN_ENB_FOOT_RIGHT, PIN_DIR_FOOT_RIGHT, PIN_PWM_FOOT_RIGHT,
...
DriverControllerEncod driverHipLeft(PIN_DRIVER_HIP_LEFT_INA, PIN_DRIVER_HIP_LEFT_INB, PIN_DRIVER_HIP_LEFT_PWM,
DRIVER_ENCOD_KP, DRIVER_ENCOD_KI, DRIVER_ENCOD_KD, DRIVER_DT, encodHipLeftAdj);

DriverControllerEncod driverKneeLeft(PIN_DRIVER_KNEE_LEFT_INA, PIN_DRIVER_KNEE_LEFT_INB, PIN_DRIVER_KNEE_LEFT_PWM,
DRIVER_ENCOD_KP, DRIVER_ENCOD_KI, DRIVER_ENCOD_KD, DRIVER_DT, encodKneeLeftAdj);

DriverControllerPoten driverFootLeft(PIN_DRIVER_FOOT_LEFT_DIR, PIN_DRIVER_FOOT_LEFT_PWM,
DRIVER_POTEN_KP, DRIVER_POTEN_KI, DRIVER_POTEN_KD, DRIVER_DT, &getAngleFootLeftADC);

DriverControllerEncod driverHipRight(PIN_DRIVER_HIP_RIGHT_INA, PIN_DRIVER_HIP_RIGHT_INB, PIN_DRIVER_HIP_RIGHT_PWM,
DRIVER_ENCOD_KP, DRIVER_ENCOD_KI, DRIVER_ENCOD_KD, DRIVER_DT, encodHipRightAdj);

DriverControllerEncod driverKneeRight(PIN_DRIVER_KNEE_RIGHT_INA, PIN_DRIVER_KNEE_RIGHT_INB, PIN_DRIVER_KNEE_RIGHT_PWM,
DRIVER_ENCOD_KP, DRIVER_ENCOD_KI, DRIVER_ENCOD_KD, DRIVER_DT, encodKneeRightAdj);

DriverControllerPoten driverFootRight(PIN_DRIVER_FOOT_RIGHT_DIR, PIN_DRIVER_FOOT_RIGHT_PWM,
